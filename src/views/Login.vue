...
import AccountComponents from "@/components/login/Account.vue";
...
.login {
  background-image: url(@/assets/images/background-wave-orig2.svg),
    url(@/assets/images/background.svg);
  background-position: center 250px, center center;
  background-repeat: no-repeat;
  background-size: 2547px 980px, cover;
